...
toTest = [5000, 10000, 20000, 40000, 80000]
...
if __name__ == "__main__": 
    ...
    for test_case in toTest:
        ...
        sampled_params, total_iterations = run_mcmc(iteration=test_case)
        end = time.time()
    ...
    np.savetxt('iteration.txt', results, delimiter=',', header='Test_Case, RMSE_Mean, RMSE_Max, MAE_Mean, MAE_Max', comments='')
