...
if __name__ == "__main__": 
    ...
    burnin = int(total_iterations / test_case)
    ...
    np.savetxt(f'{test_case}_burnin.txt', results, delimiter=',', header='Test_Case, RMSE_Mean, RMSE_Max, MAE_Mean, MAE_Max, Time', comments='')
