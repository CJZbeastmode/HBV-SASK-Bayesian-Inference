...
if __name__ == "__main__": 
    ...
    sampled_params, total_iterations = run_mcmc(max_probability=test_case)
    end = time.time()
    timed = end-start
    ...
    np.savetxt('F_max_sampling.txt', results, delimiter=',', header='Test_Case, RMSE_Mean, RMSE_Max, MAE_Mean, MAE_Max, Time', comments='')
