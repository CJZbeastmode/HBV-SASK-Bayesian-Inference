...
if __name__ == "__main__":
    ...
    for item in range(len(to_benchmark)):
        ...
        for case in test_case:
            ...
            mcmc_samples, total_iterations = run_mcmc_gpmh(
                num_proposals=num_proposals,
                num_accepted=num_accepted,
                likelihood_dependence=dictionary[0],
                likelihood_sd=dictionary[1],
                sd_transition_factor=dictionary[2],
            ...
            samples = pd.DataFrame(
                mcmc_samples, columns=["TT", "C0", "beta", "ETF", "FC", "FRAC", "K2"]
            )
