...
if __name__ == "__main__": 
    ...
    for test_case in toTest:
        ...
        burnin = int(total_iterations / toTest)
        ...
        results.append([1 / test_case, rmse_mean, rmse_max, mae_mean, mae_max])

    np.savetxt('burnin.txt', results, delimiter=',', header='Test_Case, RMSE_Mean, RMSE_Max, MAE_Mean, MAE_Max', comments='')
