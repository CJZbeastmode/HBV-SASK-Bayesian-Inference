...
if __name__ == "__main__": 
    ...
    for case in test_cases:
        ...
        iterations = case[1]
        start = time.time()
        results = run_mcmc_mh_parallel(num_chains=num_chains, iterations=iterations, max_probability=False, sd_transition_factor=6, likelihood_dependence=True, sd_likelihood=0.2)
        end = time.time()
        timed = end - start
