...
if __name__ == "__main__": 
    ...
    results.append([test_case, rmse_mean, rmse_max, mae_mean, mae_max, timed])

    np.savetxt(f'{test_case}_iteration.txt', results, delimiter=',', header='Test_Case, RMSE_Mean, RMSE_Max, MAE_Mean, MAE_Max, Time', comments='')
