...
to_benchmark = [sampling_otb, sensitivity_transition, sensitivity_likelihood_independent, sensitivity_likelihood_dependent, max_sampling, iteration, burnin_factor, init_method]
...
if __name__ == "__main__": 
    ...
    for item in range(len(to_benchmark)):
        ...
        for case in test_case:
            ...
            results.append([case, rmse_mean, rmse_max, mae_mean, mae_max, timed])
