...
if __name__ == "__main__": 
    ...
    results = [test_case, rmse_mean, rmse_max, mae_mean, mae_max]

    np.savetxt('24_sensitivity_transition.txt', results, delimiter=',', header='Test_Case, RMSE_Mean, RMSE_Max, MAE_Mean, MAE_Max', comments='')
